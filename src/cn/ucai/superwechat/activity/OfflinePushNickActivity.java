...
public class OfflinePushNickActivity extends BaseActivity {
	...
	protected void onCreate(Bundle arg0) {
		...
		super.onCreate(arg0);
		setContentView(cn.ucai.superwechat.R.layout.activity_offline_push);

		inputNickName = (EditText) findViewById(cn.ucai.superwechat.R.id.et_input_nickname);
		saveNickName = (Button) findViewById(cn.ucai.superwechat.R.id.btn_save);
		nicknameDescription = (TextView) findViewById(cn.ucai.superwechat.R.id.tv_nickname_description);
